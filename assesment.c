...
{
    vector V = create_v(v1.j*v2.k - v1.k * v2.j,v1.k*v2.i -v1.i * v2.k,v1.i * v2.j - v1.j*v2.i);  //determinant of matrix
    return V;
}
...
Quaternion mul(Quaternion q1,Quaternion q2)
{
    ...
    vector v_new = create_v(q1.scalar * q2.v.i + q2.scalar*q1.v.i + crosspro.i,
	    ...
	    q1.scalar * q2.v.k + q2.scalar * q1.v.k + crosspro.k); //calculating the vector part
